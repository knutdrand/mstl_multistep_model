...
| 15 | config_arima012 | **code** | **shared fixed ARIMA(0,1,2) order for all locations** instead of per-location AutoARIMA selection (user idea) | **0.31354** | **81.77** | — | — | **CHAMPION** ✅✅ −2.0% log-CRPS / −1.3% CRPS vs config_tgtlag3_var — biggest win of the session. Removes per-location order-selection noise (AutoARIMA overfits high-order/drift on short series). Combined-with-bank + order sweep in flight. |
